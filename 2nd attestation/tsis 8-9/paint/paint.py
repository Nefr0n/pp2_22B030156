...
#buttons and icons
brush = pygame.image.load("kist.png")
...
class brush(buttons):
    def __init__(self):
        self.width = 50
        self.image = pygame.transform.scale(pygame.image.load('kist.png'), (50, 50))
...
class erase(buttons):
    def __init__(self):
        self.width = 50
        self.image = pygame.transform.scale(pygame.image.load('erase.png'), (self.width, self.width))
        self.rect = self.image.get_rect()
...
class right_three(buttons):
    def __init__(self):
        self.width = 50
        self.image = pygame.transform.scale(pygame.image.load('images/right_triangle.png'), (self.width, self.width))
        self.rect = self.image.get_rect()
...
class square(buttons):
    def __init__(self):
        self.width = 50
        self.image = pygame.transform.scale(pygame.image.load('images/square.png'), (self.width, self.width))
        self.rect = self.image.get_rect()
...
class triangle(buttons):
    def __init__(self):
        self.width = 50
        self.image = pygame.transform.scale(pygame.image.load('images/equalitarial_triangle.png'), (self.width, self.width))
        self.rect = self.image.get_rect()
...
class rhomb(buttons):
    def __init__(self):
        self.width = 50
        self.image = pygame.transform.scale(pygame.image.load('images/rhombus.png'), (self.width, self.width))
        self.rect = self.image.get_rect()
...
class Brush(buttons):
    def __init__(self, *args, **kwargs):
        ...
        self.image = pygame.transform.scale(pygame.image.load('images/brush.png'), (40, 40))
...
class Eraser(buttons):
    def __init__(self, *args, **kwargs):
        self.pos = pygame.mouse.get_pos()
        self.image = pygame.transform.scale(pygame.image.load('images/eraser.png'), (20, 20))
        self.rect = self.image.get_rect()
        self.rect.bottomleft = self.pos
    def draw(self, surf):
